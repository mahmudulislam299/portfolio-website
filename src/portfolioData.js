...
export const portfolio = {
  ...
  projects: [
    ...
    { title: "Remote Battery Monitoring", subtitle: "IoT · Telecom · GSM/4G", description: "Monitors 48V Li-ion backup batteries at telecom towers — voltage, current, SOC, temperature — with GSM/4G remote data transmission and real-time alerting.", tags: ["GSM/4G", "Li-ion BMS", "IoT", "C Firmware", "Cloud"], color: "#9333EA", image: "/bms.png" },
    { title: "4G OpenWRT Cellular Router", subtitle: "OpenWRT · Networking · Embedded", description: "OpenWRT-based cellular router with UART data ingestion, eMMC local storage, 4G/LTE uplink, and full technical documentation for engineering team handover.", tags: ["OpenWRT", "4G/LTE", "UART", "eMMC", "Networking"], color: "#a855f7", image: "/tespack_project.png" },
    { title: "VuAI Workplace AI Sensor", subtitle: "RTOS · OTA · Power Optimization", description: "RTOS firmware optimization, power profiling, OTA firmware update via Linux-based IoT gateway. Production release for workplace AI sensing device.", tags: ["FreeRTOS", "Power Optimization", "OTA", "Linux Gateway"], color: "#c026d3", image: "/vuai.png" },
    { title: "praniSheba IoT Base Station", subtitle: "TDM Sensor Network · KiCad PCB", description: "Remote cowshed environment monitoring (NH3, CH4, temp, humidity). Custom TDM-based nRF sensor network with Wi-Fi and GSM uplink.", tags: ["nRF TDM", "Wi-Fi", "GSM", "KiCad PCB", "IoT"], color: "#db2777", image: "/prianisheba_basestation.png" },
  ],
